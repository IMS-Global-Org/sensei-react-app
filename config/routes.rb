...
# api_birthdays_mailer_index POST     /api/birthdays_mailer(.:format)               api/birthdays_mailer#create
...
Rails.application.routes.draw do
  ...
  namespace :api do
    ...
    # Routes for the birthdays mailer
    resources :birthdays_mailer, only: [:create]
  end
